...
public class DateUtil {
     ...
     * 月日
     */
    public static final String PATTERN5 = "MM/dd";
     ...
     * 日月时分
     */
    public static final String PATTERN7 = "MM/dd HH:mm";
    ...
    /**
     * 指定字符串格式日期转为另一种指定字符串格式
     *
     * @param source
     * @param sourceFormatPattern
     * @param targetFormatPattern
     * @return
     */
    public static String formatStrToAnotherStr(String source, String sourceFormatPattern, String targetFormatPattern) {

        try {
            SimpleDateFormat sourceFormat = initFormat(sourceFormatPattern);
            Date parse = sourceFormat.parse(source);
            SimpleDateFormat targetFormat = initFormat(targetFormatPattern);
    ...
    public static List<String> getEveryDayStrBetweenRequiredDate(String formatPattern, Date startDate, Date endDate, Integer flag) {
        Integer interval = flag;
        flag --;
        SimpleDateFormat format = initFormat(formatPattern);
    ...
    public static Long getSecondByDate(Date date) {
        ...
        String millisecondStr = ((Long) (date.getTime())).toString();
        String second = millisecondStr.substring(0, millisecondStr.length() - 3);
    ...
    /**
     * 获取指定偏移量(单位天)的0点的日期
     * @param offsetDay 偏移量(单位天)
     */
    public static Date getEarliestDateTimeByOffset(Integer offsetDay) {
    ...
    /**
     * 获取指定偏移量(单位天)的23.59.59的日期
     * @param offsetDay 偏移量(单位天)
     */
    public static Date getLatestDateTimeByOffset(Integer offsetDay) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getLastDayOfMonth(2020, 2));
    }
